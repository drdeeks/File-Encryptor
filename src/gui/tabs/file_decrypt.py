...
class DecryptFileTab(ctk.CTkFrame if USE_MODERN_UI else ttk.Frame):
    ...
    def create_widgets(self):
        ...
        # Decrypt button
        decrypt_button = ctk.CTkButton(self, text="Decrypt File", command=self.decrypt_file) if USE_MODERN_UI else ttk.Button(self, text="Decrypt File", command=self.decrypt_file)
    ...
    def decrypt_file(self):
        ...
        def do_decrypt():
            try:
                ...
                messagebox.showinfo("Success", f"File decrypted to {output}")
